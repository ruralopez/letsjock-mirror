...
=end
  ...
  # POST /users.json
  def create
    @user = User.new(:phone => 18, :citybirth => "City", :country_id => 46, :resume => "", :email => params[:email], :password => params[:password], :name => params[:name], :lastname => params[:lastname], :isSponsor => false, :authentic_email => true, :gender => params[:gender])
